...
dfm = pd.read_csv('fpl_am.csv')
 #Value per 90 and App
 
dfm["Value"] = (dfm.Points / dfm.Price)
dfm['Value/90'] = (dfm.Value / dfm.Time) * 90
dfm['Value/App'] = (dfm.Value / dfm.App)
...
df_.to_csv("cleanfpl_a.csv", index = False)
